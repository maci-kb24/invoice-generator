          ...
          <div className="w-full flex-1 mt-8 p-8 order-2 bg-white shadow-xl rounded-3xl sm:w-96 lg:w-full lg:order-1 border-dashed">
            ...
            <ul className="mb-7">
              <li className="flex mb-2">
                <Image src="https://res.cloudinary.com/williamsondesign/check-grey.svg" alt="check grey" width={15} height={15} />
                <p className="ml-3 text-neutral-500">Custom Logo</p>
              </li>
              <li className="flex mb-2">
                <Image src="https://res.cloudinary.com/williamsondesign/check-grey.svg" alt="check grey" width={15} height={15} />
                <p className="ml-3 text-neutral-500">Multiple Templates</p>
              </li>
              <li className="flex">
                <Image src="https://res.cloudinary.com/williamsondesign/check-grey.svg" alt="check grey" width={15} height={15} />
                <p className="ml-3 text-neutral-500">100 invoices</p>
              </li>
            </ul>
            <Link
              href="https://buy.stripe.com/7sI7vz5TralBbTy7sv"
              className="flex items-center justify-center whitespace-nowrap rounded-lg transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring font-medium disabled:pointer-events-none disabled:opacity-50 bg-gradient-to-br from-orange-500 to-pink-400 text-white hover:bg-black/90 px-6 py-2 text-lg"
            >
              Get Started
            </Link>
          </div>
          ...
          <div className="w-full flex-1 p-8 order-1 shadow-xl rounded-3xl bg-gray-900 text-gray-400 sm:w-96 lg:w-full lg:order-2 lg:mt-0">
            <div className="mb-8 pb-8 flex items-center border-b border-gray-600">
              ...
              <div className="ml-5">
                ...
                <span><span className="font-medium text-xl align-top">$&thinsp;</span><span className="text-3xl font-bold text-white">5</span></span>
              </div>
            </div>
            <ul className="mb-10">
              <li className="flex mb-6">
                <Image src="https://res.cloudinary.com/williamsondesign/check-white.svg" alt="check white" width={15} height={15} />
                <span className="ml-3">All features in <span className="text-white">Basic</span></span>
              </li>
              <li className="flex mb-6">
                <Image src="https://res.cloudinary.com/williamsondesign/check-white.svg" alt="check white" width={15} height={15} />
                <span className="ml-3">Custom Templates </span>
              </li>
              <li className="flex">
                <Image src="https://res.cloudinary.com/williamsondesign/check-white.svg" alt="check white" width={15} height={15} />
                <span className="ml-3"><span className="text-white">500</span> invoices</span>
              </li>
            </ul>
            <Link
              href="https://buy.stripe.com/4gw6rv1Db3Xd8HmbIM"
              className="flex items-center justify-center whitespace-nowrap rounded-lg transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring font-medium disabled:pointer-events-none disabled:opacity-50 bg-gradient-to-br from-orange-500 to-pink-400 text-white hover:bg-black/90 px-6 py-2 text-lg"
            >
              Get Started
            </Link>
          ...
          <div className="w-full flex-1 mt-8 p-8 order-3 bg-white shadow-xl rounded-3xl sm:w-96 lg:w-full lg:order-3">
            <div className="mb-7 pb-7 flex items-center border-b border-gray-300">
              ...
              <div className="ml-5">
                ...
                <span><span className="font-medium text-gray-500 text-xl align-top">$&thinsp;</span><span className="text-3xl font-bold">9</span></span>
              </div>
            </div>
            <ul className="mb-7">
              <li className="flex text-lg mb-2">
                <Image src="https://res.cloudinary.com/williamsondesign/check-grey.svg" alt="check grey" width={15} height={15} />
                <span className="ml-3 text-neutral-500">All features in <span className="text-black">Startup</span></span>
              </li>
              <li className="flex text-lg mb-2">
                <Image src="https://res.cloudinary.com/williamsondesign/check-grey.svg" alt="check grey" width={15} height={15} />
                <span className="ml-3 text-neutral-500">1000 templates</span>
              </li>
              <li className="flex text-lg">
                <Image src="https://res.cloudinary.com/williamsondesign/check-grey.svg" alt="check grey" width={15} height={15} />
                <span className="ml-3 text-neutral-500">1000 invoices</span>
              </li>
            </ul>
            <Link
              href="https://buy.stripe.com/4gwdTX0z7alB8HmcMS"
              className="flex text-center items-center justify-center whitespace-nowrap rounded-lg transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring font-medium disabled:pointer-events-none disabled:opacity-50 bg-gradient-to-br from-orange-500 to-pink-400 text-white hover:bg-black/90 px-6 py-2 text-lg"
            >
              Get Started
            </Link>
          </div>
